...
public: 
  ...
  void left_curve_to_angle(float angle, float ratio);
  void left_curve_to_angle(float angle, float ratio, float swing_max_voltage, float swing_settle_error, float swing_settle_time, float swing_timeout, float swing_kp, float swing_ki, float swing_kd, float swing_starti);
  void left_slow_curve_to_angle(float angle, float ratio);
  void left_slow_curve_to_angle(float angle, float ratio, float swing_max_voltage, float swing_settle_error, float swing_settle_time, float swing_timeout, float swing_kp, float swing_ki, float swing_kd, float swing_starti);
  ...
  void right_curve_to_angle(float angle, float ratio);
  void right_curve_to_angle(float angle, float ratio, float swing_max_voltage, float swing_settle_error, float swing_settle_time, float swing_timeout, float swing_kp, float swing_ki, float swing_kd, float swing_starti);
  void right_slow_curve_to_angle(float angle, float ratio);
  void right_slow_curve_to_angle(float angle, float ratio, float swing_max_voltage, float swing_settle_error, float swing_settle_time, float swing_timeout, float swing_kp, float swing_ki, float swing_kd, float swing_starti);
  Odom odom;
